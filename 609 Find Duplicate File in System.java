        ...
        for (String path : paths) {
            ...
            if (files != null) {
                ...
                for (int i = 1; i < files.length; ++i) {
                    ...
                    int idx2 = files[i].indexOf(")");
                    
                    String file = files[i].substring(0, idx1);
                    String content = files[i].substring(idx1 + 1, idx2);
                    
                    hash.put(content, hash.computeIfAbsent(content, k -> new ArrayList<String>())).add(dir + "/" + file);
                }
            }
        }
